...
<head>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <li class="nav-item">
            <a href="customerList.php" class="nav-link active pr-3"><h4>Customer List</a>
             </li> 
            <li class="nav-item">
		...
		<table align="center" border="1px" style="width:800px; line-height:40px">
			<tr>
				<th colspan="5"  id="t01"><h2>Customer List</h2></th>
			</tr>
			<t>
				<th id="t01"> ID</th>
				<th  id="t01"> Customer Name </th>
				<th  id="t01"> Email Address </th>
				<th  id="t01"> Balance (Rs.) </th>
				<th  id="t01"> Transfer </th>
			</t>
			...
			<tr>
				...
				<td align="center"><a href="transfer.php?id= <?php echo $rows['User_ID'] ;?>"> <button type="button" id="idel" class="btn btn-primary btn-lg">Transact</button></a>
			</tr>
			<?php
				}
		?>
